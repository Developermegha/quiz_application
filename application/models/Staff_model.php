...
class Staff_model extends CI_Model
{
     ...
     public function fetchAllQuestion_staffwise()
    {
        ...
        $this->db->select('q.*,course.course_name');
    ...
    public function fetchAlltopics_staffwise()
     {
        ...
        $this->db->where('t.quiz_type_id',1);
        $query = $this->db->get();
        if($query->num_rows() > 0){
     ...
     public function fetchAllunits_staffwise()
     {
         $cid=$_SESSION['course_id'];
        $response = array();
        $this->db->select('t.*,c.course_name');
        ...
        $this->db->where('t.is_deleted',0);
        $this->db->where('t.course_id',$cid);
        $this->db->where('t.quiz_type_id',2);
        $query = $this->db->get();
        if($query->num_rows() > 0){
            $response = $query->result_array();
        }
    ...
    public function fetchAllQuiz()
    {
        ...
        //$this->db->join('questionset', 'questionset.quiz_id = quiz_master.id');
        // $this->db->join('quiz_status', 'quiz_status.id = quiz_master.quiz_stauts_id');
        ...
        $this->db->where('quiz_master.course_id',$cid); 
    ...
    public function add_Question($data)
    {
        ...
        if($this->db->affected_rows() > 0)
        {
            ...
            else if(isset($_FILES['correct_ans_img']))
            {
    ...
    */
    ...
    public function fetchtopicsquestions($topic_name)
    {
       // echo "select * from questionset where qst_type='$qst_type' and qst_attribute_name='$topic_name'";
        ...
        $this->db->where('quiz_master.type_id',$topic_name);
   ...
   */
   ...
   public function getQuizDetails($id)
   {
        ...
        $this->db->join('topics as t','t.id=qm.topic_id');
        $this->db->join('course as c','c.id = qm.course_id');
        $this->db->join('questionset as q','q.quiz_id=qm.id');
   ...
   public function getStudResult()
    {
        ...
        $this->db->where('quiz.student_id',$stud_id);
    ...
    */
    public function getTotalActiveQuiz($cid){
        //$cid=$_SESSION['course_id'];
    ...
    public function getTotalDeletedQuizList(){
        ...
        $this->db->join('quiz_type', 'quiz_type.id = quiz_master.type_id');
        $this->db->join('topics', 'topics.id = quiz_master.topic_id');
        $this->db->where('quiz_master.is_deleted',1);
    ...
    */
    public function getQuizCount($cid)
    {
    ...
    */
    public function gettopicCount($cid)
    {
        $this->db->select('count(id) as totalQuiz');
        $this->db->from('topics');
        $this->db->where('is_deleted',0);
        $this->db->where('course_id',$cid);
        $this->db->where('quiz_type_id',1);
        $query = $this->db->get();
        if($query->num_rows() > 0 ){
            $response = $query->row()->totalQuiz;
        }
    ...
    */
    public function getunitCount($cid)
    {
        $this->db->select('count(id) as totalQuiz');
        $this->db->from('topics');
        $this->db->where('is_deleted',0);
        $this->db->where('course_id',$cid);
        $this->db->where('quiz_type_id',2);
        $query = $this->db->get();
        if($query->num_rows() > 0 ){
            $response = $query->row()->totalQuiz;
        }
    ...
    * get total topic count
    */
    public function getsyllabusCount($cid)
    {
        $this->db->select('count(id) as totalQuiz');
        $this->db->from('topics');
        $this->db->where('is_deleted',0);
        $this->db->where('course_id',$cid);
        $this->db->where('quiz_type_id',3);
        $query = $this->db->get();
        if($query->num_rows() > 0 ){
            $response = $query->row()->totalQuiz;
        }
    ...
    public function updateStaffUserDetails($id,$data)
    {
       // echo $id;
       // print_r($data);die;
            $this->db->set($data);
