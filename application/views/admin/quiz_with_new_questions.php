  ...
  <!-- /.content-wrapper -->
    ...
    function addFields() 
    {
        ...
        for (i = 0; i < number; i++) 
        {
            ...
            $("#container").append("<div class='col-md-12'><div class='form-group'>  " + " <input type='file'  class='form-control' name='question_img[]' placeholder='Question_Image " + (i+1)+ "'  style='width: 100%;' /></div></div>");
            // $("#container").append("<div class='col-md-6'><div class='form-group'>  " + " <input type='radio'  class='form-control' name='img_text' value='"+ (i+1)+"'  style='width: 100%;' /></div></div>");
            
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='text' class='form-control' name='answer[]' placeholder='Answer 1'  style='width: 100%;' required/></div></div>");
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='file' class='form-control' name='answer_img[]'  style='width: 100%;' /></div></div>");
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='text' class='form-control' name='answer[]' placeholder='Answer 2'  style='width: 100%;' required/></div></div>");
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='file' class='form-control' name='answer_img[]'  style='width: 100%;' /></div></div>");
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='text' class='form-control' name='answer[]' placeholder='Answer 3'  style='width: 100%;' required/></div></div>");
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='file' class='form-control' name='answer_img[]'  style='width: 100%;' /></div></div>");
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='text' class='form-control' name='answer[]' placeholder='Answer 4'  style='width: 100%;' required/></div></div>");
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='file' class='form-control' name='answer_img[]'  style='width: 100%;' /></div></div>");
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='text' class='form-control' name='answer[]' placeholder='Correct Answer'  style='width: 100%;' required /></div></div>");
            $("#container").append("<div class='col-md-6'><div class='form-group'> " +  " " + " <input type='file' class='form-control' name='answer_img[]'  style='width: 100%;' /></div></div>");
