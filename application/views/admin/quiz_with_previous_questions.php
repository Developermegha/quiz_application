    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
            <div class="card-body">
                <form method="post" action="<?php echo base_url('admin/insert_quiz_previous_question') ?>">
                    <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" >
                            ...
                            <select class="form-control select2" style="width: 100%; " name='attribute_name' id='attribute_name' required onchange='getQuestionFunction()'>
