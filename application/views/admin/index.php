...
<!-- jQuery -->
<script src="<?php echo base_url('assets/plugins/jquery/jquery.min.js"></scrip') ?>t>
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url('assets/plugins/jquery-ui/jquery-ui.min.js"></scrip') ?>t>
