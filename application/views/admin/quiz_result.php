            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                   <?php echo $studResult[0]['course_name'] ?>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $studResult[0]['topic_name']; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $total_mark=$studResult[0]['max_marks']; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $total_mark=$studResult[0]['quiz_total_time']; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
              ...
              <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class='row'>
                                <div class='col-12'><h3>Your Score is : <b><?php echo $FM ?>/<?php echo $total_mark ?></b></h3></div>
                                <div class='col-12'><h3>Your Percentage : <b><?php echo $per ?>%</b></h3></div>
                            </div>
                        </div>
                    </div>    
