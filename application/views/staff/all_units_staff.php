        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
                <div class='col-sm-3 float-sm-right'>
                    <!--<a href='<?php echo base_url('staff/addTopic') ?>' class="btn btn-block bg-gradient-success float-sm-right">Add Topic</a>-->
                            ...
                            <div class="card bg-light d-flex flex-fill">
                                ...
                                <div class="card-body pt-0">
                                  <div class="row">
                                    <div class="col-12">
                                      ...
                                      <p class="text-muted text-sm"><b>Course: </b>  <?php echo $t['course_name'] ?> </p>
                                ...
                                <div class="card-footer">
                                   <div class="text-right1">
                                        ...
                                        <?php } ?>
                                        <a href="<?php echo base_url()?>staff/DeleteTopic/<?php echo $id=$t['id'] ?>" class="btn btn-sm bg-danger">
                                          <i class="fas fa-trash"></i> Delete
                                        </a>
                                        <a href="<?php echo base_url()?>staff/edit_topic/<?php echo $t['id'] ?>"  class="btn btn-sm btn-primary" >
            ...
            <div class="modal-content">
                <form method='post' action='<?php echo base_url('staff/insert_topic'); ?>'>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">Create new Topic / Unit</button>
                    </div>
                </form>
            </div>
          <!-- /.modal-content -->
