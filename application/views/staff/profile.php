              ...
              <div class="card-body">
                <div class="tab-content">
                    <div class="active tab-pane" id="allstudentdata">
                        <form class="form-horizontal" method="post" action="<?php echo base_url('staff/profileupdate');    ?>">
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">First Name</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="<?php  echo $staffData->username; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="<?php  echo $staffData->email; ?>">
                        </div>
                      </div>
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url('staff/change_password'); ?>">
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Old Password</label>
                        <div class="col-sm-10">
                          <input type="password" class="form-control" id="old_password" name="old_password" placeholder="Old Password" value="<?php  echo encrypt_script($staffData->password); ?>">
                        </div>
                      </div>
                      <div class="form-group row">
