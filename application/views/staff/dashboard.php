          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                {
                ?> 0 <?php } ?><sup style="font-size: 20px">%</sup></h3>
          ...
          <div class="col-lg-2 col-6">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Latest Quizes</h3>
                  ...
                  <table class="table m-0">
                    ...
                    <tr>
                      ...
                      <td> <?php
                                    ...
                                    <?php } ?><!--<span class="badge badge-success">Shipped</span>--></td>
                     <!-- <td>
